...
**가톨릭대학교 GGUM 해커톤** (1박 2일, 2024)에서 시작한 물건 대여 플랫폼입니다. 대학생 간 유휴 물건을 쉽게 빌려주고 빌릴 수 있는 서비스를 목표로, 11인 팀으로 개발했습니다.

해커톤 종료 후 코드 정합성 개선 및 성능 최적화를 거쳐 포트폴리오 수준으로 발전시켰습니다.

| 구분 | 내용 |
|------|------|
| **이벤트** | 가톨릭대학교 GGUM 해커톤 (1박 2일, 2024) |
| **팀 구성** | 11명 — PM 2, 디자이너 1, 프론트엔드 2, 백엔드 6 |
| **본인 담당** | 예약 시스템 (Pessimistic Lock), 성능 최적화 (N+1, k6), 알림 시스템 |
